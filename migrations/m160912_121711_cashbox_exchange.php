    ...
    public function safeUp()
    {
        ...
        $this->createTable(
            ...
            [
                ...
                'from_sum'=> $this->decimal(2, 10)->notNull()->defaultValue('0.00'),
                'to_cashbox_id'=> $this->integer(11)->notNull(),
                'to_sum'=> $this->decimal(2, 10)->notNull()->defaultValue('0.00'),
                'date'=> $this->datetime()->notNull(),
                'rate'=> $this->decimal(2, 10)->notNull()->defaultValue('1.00'),
